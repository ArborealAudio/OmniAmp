...
AudioProcessorValueTreeState::ParameterLayout GammaAudioProcessor::createParams()
{
    ...
    params.emplace_back(std::make_unique<AudioParameterFloat>("inputGain", "Input Gain", 0.f, 18.f, 0.f));
    params.emplace_back(std::make_unique<AudioParameterFloat>("outputGain", "Output Gain", 0.f, 24.f, 0.f));
