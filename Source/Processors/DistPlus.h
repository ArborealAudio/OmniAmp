...
//     void setParams(float newDist)
//     {
//         Rdist.setResistanceValue(newDist);
//     }
...
// private:
//     WDF::ResistiveVoltageSource<float> Vin;

//     WDF::Resistor<float> R1{10000.f};
//     WDF::Resistor<float> R2{1000000.f};
//     WDF::Resistor<float> R3{4700.f};
//     WDF::Resistor<float> R4{1000000.f};
//     WDF::Resistor<float> R5{10000.f};
//     WDF::Resistor<float> Rdist{1000000.f};

//     WDF::Capacitor<float> C1{1e-9f};
//     WDF::Capacitor<float> C2{10e-9f};
//     WDF::Capacitor<float> C3{47e-9f};
//     WDF::Capacitor<float> C4{1e-6f};
//     WDF::Capacitor<float> C5{1e-9f};

//     WDFT::WDFSeriesT<float, decltype(R1), decltype(C2)> S1{R1, C2};
//     WDFT::WDFSeriesT<float, decltype(S1), decltype(R2)> S2{S1, R2};
//     WDFT::WDFSeriesT<float, decltype(Rdist), decltype(R3)> S3{Rdist, R3};
//     WDFT::WDFSeriesT<float, decltype(S3), decltype(C3)> S4{S3, C3};
//     WDFT::WDFSeriesT<float, decltype(C4), decltype(R5)> S6{C4, R5};

//     WDFT::WDFParallelT<float, decltype(Vin), decltype(C1)> P1{Vin, C1};
//     WDFT::WDFParallelT<float, decltype(P1), decltype(S2)> P2{P1, S2};
...
//         {
//             constexpr float Ag = 100.f;
//             constexpr float Ri = 1e9f;
//             constexpr float Ro = 1e-1f;

//             return Ag;
//         }
//     };

//     WDFT::RtypeAdaptor<float, 0, ImpedanceCalc, decltype(P2), decltype(S4), decltype(R4)> R{std::tie(P2, S4, R4)};

//     WDFT::WDFSeriesT<float, decltype(R), decltype(S6)> S7{R, S6};
//     WDFT::WDFParallelT<float, decltype(S7), decltype(C5)> P3{S7, C5};
//     WDFT::DiodePairT<float, decltype(P3)> Dp{P3, 2.52e-9f};
// };
