...
our %config = (
    ...
    "conf_files" => [
        "/home/alex/dev/OmniAmp/1.0.3/modules/openssl/Configurations/00-base-templates.conf",
        "/home/alex/dev/OmniAmp/1.0.3/modules/openssl/Configurations/10-main.conf"
    ],
    "cppflags" => [],
    "cxxflags" => [],
    "defines" => [
...
our %target = (
    ...
    "_conf_fname_int" => [
        ...
        "/home/alex/dev/OmniAmp/1.0.3/modules/openssl/Configurations/10-main.conf",
        "/home/alex/dev/OmniAmp/1.0.3/modules/openssl/Configurations/10-main.conf",
        "/home/alex/dev/OmniAmp/1.0.3/modules/openssl/Configurations/shared-info.pl"
    ],
    "asm_arch" => "x86_64",
    "bin_cflags" => "",
    "bin_lflags" => "",
...
unless (caller) {
    ...
    use lib '/home/alex/dev/OmniAmp/1.0.3/modules/openssl/util/perl';
    use OpenSSL::fallback '/home/alex/dev/OmniAmp/1.0.3/modules/openssl/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib '/home/alex/dev/OmniAmp/1.0.3/modules/openssl/Configurations';
        use gentemplate;
