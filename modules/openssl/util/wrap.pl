...
BEGIN {
    ...
    require '/home/alex/dev/OmniAmp/1.0.3/modules/openssl/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/home/alex/dev/OmniAmp/1.0.3/modules/openssl/test/fips-and-base.cnf';
    shift;
...
if ($ARGV[0] eq '-jitter') {
    $std_openssl_conf = '/home/alex/dev/OmniAmp/1.0.3/modules/openssl/test/default-and-jitter.cnf';
    shift;
