...
static const char * const curlman[] = {
  ...
  "    the --silent option.",
  "\nVERSION",
  "\n    This man page describes  curl 8.22.0. If you  use a later version,  chances",
  ...
  "\t    file format. We discourage the use of the HTTP header style.",
  ...
  "\t    \"Set-Cookie\"  line  specifies  a  \"Domain\"  attribute.  Without  an",
  "\t    explicit domain, the cookie cannot be reliably matched to a  target",
  "\t    host and may be  applied in unexpected  ways. We suggest using  the",
  "\t    Netscape file format instead.",
  ...
  "\n\t    The source code  output should  be considered example  code and  is",
  "\t    not production ready. You must double-check that the code  actually",
  "\t    does what you want it do.",
  "\n\t    This option is global  and does not need  to be specified for  each",
  ...
  "\t    protocol  name  or  'all',  optionally  prefixed  by  a   modifier.",
  ...
  "\n    -s, --silent",
  "\t    Silent or quiet mode.  Do not show  progress meter, note  messages,",
  "\t    warning messages  or  error messages.  Makes  curl mute.  It  still",
  "\t    outputs  the   data  you   ask  for,   potentially  even   to   the",
  ...
  "\t    curl/8.22.0. If --user-agent  is provided several  times, the  last",
  "\t    set value is used.",
  "\n\t    Example:",
